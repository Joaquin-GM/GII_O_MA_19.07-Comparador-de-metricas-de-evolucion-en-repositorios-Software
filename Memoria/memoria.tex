...
\begin{abstract}
Métricas de evolución, proceso de desarrollo de software, ciclo de vida de desarrollo de software, gestión de calidad, aseguramiento de calidad, forjas de repositorios, repositorios de código, GitLab, GitHub, comparación de proyectos software, desarrollo web, aplicaciones web. \ldots
\end{abstract}
