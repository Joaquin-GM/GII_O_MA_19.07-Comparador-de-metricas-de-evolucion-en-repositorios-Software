...
\begin{figure}[!h]
	\centering
	\includegraphics[width=1\textwidth]{M5_Eclipse_Java11}
...
% TODO siguientes secciones, consultar propuesta de las mismas
...
% incluir JaCoCo con Maven para la generación de los informes
\subsection{Gestión de la calidad: Codacy}
\subsection{Despliegue automático: Heroku}
