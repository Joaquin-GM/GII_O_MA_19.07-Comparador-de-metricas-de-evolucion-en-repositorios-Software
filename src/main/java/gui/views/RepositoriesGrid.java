...
public class RepositoriesGrid extends Grid<Repository> {
	...
	public RepositoriesGrid() {
		...
		initializeGrid();
		MetricsService.getMetricsService().addCurrentMetricProfileChangedEventListener(event -> onMetricProfileChanged());
	}
	...
	private void initializeGrid() {
		...
		addComponentColumn(repository -> createRemoveButton(repository))
